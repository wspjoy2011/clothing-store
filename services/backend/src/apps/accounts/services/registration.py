...
from apps.accounts.dto.users import CreateUserDTO, UserDTO
...
from apps.accounts.interfaces.services import RegistrationServiceInterface
...
class RegistrationService(RegistrationServiceInterface):
    """Service for creating accounts and getting them activated"""
